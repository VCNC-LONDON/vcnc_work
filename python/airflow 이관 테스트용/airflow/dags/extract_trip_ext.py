...
with models.DAG(
    dag_id="Extract-trip-ext",
    description="Extract trip_ext",
    ...
    query_task = BigQueryOperator(
        ...
        task_id="extract_trip_ext",
        sql=utils.read_sql(os.path.join(os.environ["DAGS_FOLDER"], "sql/trip_ext.sql")),
        use_legacy_sql=False,
        destination_dataset_table="kr-co-vcnc-tada.tada_ext.trip_ext",
        write_disposition="WRITE_TRUNCATE",
        on_failure_callback=task_fail_slack_alert,
        time_partitioning={"type": "DAY", "field": "created_date_kr"},
    )
