...
with models.DAG(
    dag_id="Extract-trip-review-by-driver-ext",
    description="Extract trip_review_by_driver_ext",
    ...
    query_task = BigQueryOperator(
        ...
        task_id="extract_trip_review_by_driver_ext",
        sql=utils.read_sql(
            os.path.join(os.environ["DAGS_FOLDER"], "sql/trip_review_by_driver_ext.sql")
        ),
        use_legacy_sql=False,
        destination_dataset_table="kr-co-vcnc-tada.tada_ext.trip_review_by_driver_ext",
