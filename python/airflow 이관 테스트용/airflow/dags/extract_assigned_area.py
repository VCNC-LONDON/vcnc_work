...
with models.DAG(
    dag_id="Extract-assigned-area",
    description="Extract assigned_area",
    ...
    query_task = BigQueryOperator(
        ...
        task_id="extract_assigned_area",
        sql=utils.read_sql(
            os.path.join(os.environ["DAGS_FOLDER"], "sql/assigned_area.sql")
        ),
        use_legacy_sql=False,
        destination_dataset_table="kr-co-vcnc-tada.tada_meta.assigned_area",
