...
with models.DAG(
    dag_id="Extract-driver-activity-agg-houly",
    description="Extract driver activity agg hourly",
    ...
    query_task = BigQueryOperator(
        ...
        task_id="extract_driver_activity_agg_hourly",
        sql=utils.read_sql(
            os.path.join(
                os.environ["DAGS_FOLDER"], "sql/driver_activity_agg_hourly.sql"
            )
        ),
        use_legacy_sql=False,
        destination_dataset_table="kr-co-vcnc-tada.tada_ext.driver_activity_agg_hourly",
