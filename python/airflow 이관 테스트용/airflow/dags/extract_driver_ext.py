...
with models.DAG(
    dag_id="Extract-driver-ext",
    description="Extract driver_ext",
    ...
    query_task = BigQueryOperator(
        ...
        task_id="extract_driver_ext",
        sql=utils.read_sql(
            os.path.join(os.environ["DAGS_FOLDER"], "sql/driver_ext.sql")
        ),
        use_legacy_sql=False,
        destination_dataset_table="kr-co-vcnc-tada.tada_ext.driver_ext",
