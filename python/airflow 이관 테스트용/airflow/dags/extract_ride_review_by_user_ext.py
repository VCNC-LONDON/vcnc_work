...
with models.DAG(
    dag_id="Extract-ride-review-by-user-ext",
    description="Extract ride_review_by_user_ext",
    ...
    query_task = BigQueryOperator(
        ...
        task_id="extract_ride_review_by_user_ext",
        sql=utils.read_sql(
            os.path.join(os.environ["DAGS_FOLDER"], "sql/ride_review_by_user_ext.sql")
        ),
        use_legacy_sql=False,
        destination_dataset_table="kr-co-vcnc-tada.tada_ext.ride_review_by_user_ext",
