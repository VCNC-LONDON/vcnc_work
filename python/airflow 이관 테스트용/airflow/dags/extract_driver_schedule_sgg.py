...
with models.DAG(
    dag_id="Extract-driver-schedule-sgg",
    description="Extract driver_schedule_sgg",
    ...
    query_task = BigQueryOperator(
        ...
        task_id="extract_driver_schedule_sgg",
        sql=utils.read_sql(
            os.path.join(os.environ["DAGS_FOLDER"], "sql/driver_schedule_sgg.sql")
        ),
        use_legacy_sql=False,
        destination_dataset_table="kr-co-vcnc-tada.tada_sim.driver_schedule_sgg",
